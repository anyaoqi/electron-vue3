...
export const extrTypeDatas: ExtrDataType[] = [
  ...
  },
  {
    ...
    apiFilds: [
      ...
      { name: "商品代码", filed: "dtl_goodsisn", type: 'Array', description: "必须" },
      { name: "条形码", filed: "dtl_barcode", type: 'Array', description: "必须" },
      { name: "数量", filed: "dtl_quantity", type: 'Array', description: "必须" },
      { name: "单价", filed: "dtl_price", type: 'Array', description: "必须" },
    ],
  },
  {
    name: "损溢单信息抽取",
